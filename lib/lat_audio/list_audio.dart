...
class _PageListAudioState extends State<PageListAudio> {
  ...
  Future<void> _fetchAudioData() async {
    try {
      final response = await http.get(Uri.parse('http://192.168.137.1/latAudio/getAudio.php'));
  ...
  Future<void> _play(int index) async {
    ...
    final audioUrl = 'http://192.168.137.1/latAudio/audio/${_audioList[index].fileAudio}';
    try {
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: Image.network(
                      'http://192.168.137.1/latAudio/gambar/${_filteredAudioList[index].gambar}',
                      width: 50,
                      height: 50,
                      fit: BoxFit.cover,
